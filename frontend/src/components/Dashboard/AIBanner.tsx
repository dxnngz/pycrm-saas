...
const AIBanner: FC<AIBannerProps> = ({ forecast, monthsAnalyzed }) => {
    return (
        <motion.div
            ...
            className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 p-1 rounded-[3rem] shadow-2xl overflow-hidden relative group"
        >
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10"></div>
            <div className="bg-slate-900/40 backdrop-blur-3xl rounded-[2.9rem] p-10 flex flex-col lg:flex-row items-center justify-between gap-10 relative z-10">
                ...
                <div className="flex items-center gap-12 border-l border-white/10 pl-12 h-20">
                    <div className="text-center">
                        <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-1">Crecimiento IA</p>
                    ...
                    <div className="text-center">
                        <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-1">Confianza</p>
