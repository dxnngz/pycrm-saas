        ...
        {loading ? (
          ...
          <div className="p-24 text-center">
            <div className="max-w-md mx-auto">
              ...
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Inventario Vacío</h3>
              <p className="text-slate-500 dark:text-slate-400 font-bold text-sm mb-8 leading-relaxed">
                Aún no tienes productos o servicios registrados. Comienza definiendo tu catálogo para gestionar ventas.
              </p>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {products.map((product) => (
                <tr key={product.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-850/50 transition-all group even:bg-slate-50/30 dark:even:bg-slate-900/20">
