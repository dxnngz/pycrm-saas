...
export const updateClient = asyncHandler(async (req: Request, res: Response) => {
    try {
        const client = await clientService.updateClientById(parseInt(req.params.id as string), req.body);
        res.json(client);
    } catch (error: any) {
...
export const deleteClient = asyncHandler(async (req: Request, res: Response) => {
    try {
        await clientService.deleteClientById(parseInt(req.params.id as string));
...
export const getClientOpportunities = asyncHandler(async (req: Request, res: Response) => {
    const opportunities = await clientService.getClientOpportunitiesById(parseInt(req.params.id as string));
