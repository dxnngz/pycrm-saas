...
export class AutomationEngine {
    ...
    private evaluateConditions(conditions: any[], data: any): boolean {
        ...
        for (const cond of conditions) {
            ...
            if (!passed) return false; // ALL conditions must be met (AND logic implied)
        }
        return true;
    }
    ...
    private async executeActions(actions: any[], payload: { tenantId: number, userId?: number, data: any }) {
